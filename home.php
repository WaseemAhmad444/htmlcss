            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-3 text-white mb-md-4">Open Account As Customer</h1>
                            <a href="register.php" class="btn btn-primary py-md-3 px-md-5 mt-2">SigUp</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Laundry & Dry Cleaning</h4>
                            <h1 class="display-3 text-white mb-md-4">Open Account As Store Manager</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Laundry & Dry Cleaning</h4>
                            <h1 class="display-3 text-white mb-md-4">Open Account As Delivery Boy</h1>
                            <a href="register.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Sign Up</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container pt-0 pt-lg-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 pl-lg-5">
                    ...
                    <h1 class="mb-4">We Are provinding a unique dry cleaning plateform in Islamabad</h1>
                    <h5 class="font-weight-medium font-italic mb-4">Where.</h5>
                    <p class="mb-2"><b>As Customer</b>: You can place order for laundry and pickup services at your door step. <b>Store Manager</b>: You can open your online dry cleaning Store. And <b>delivery Boy</b>You Can Start pickup and delivery bussiness. So You Can find here.... </p>
                    <div class="row">
