                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-3 text-white mb-md-4">Welcome... You register as a deliveryAgent</h1>
                            <a href="deliveryOrder.php" class="btn btn-primary py-md-3 px-md-5 mt-2">delivery Order</a>
                        </div>
                    </div>
                </div>
            </div>
