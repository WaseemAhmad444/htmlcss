        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                   ...
                   <a href="CustomerPage.php" class="nav-item nav-link active">Home</a>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-3 text-white mb-md-4">Welcome... You register as a Customer</h1>
                            <a href="orderSubmission.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Go Place Order</a>
                        </div>
                    </div>
                </div>
            </div>
